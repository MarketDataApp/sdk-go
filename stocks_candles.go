...
//
// Parameters:
//   - client: A variadic parameter that can accept zero or more MarketDataClient pointers. This allows
...
//
// Returns:
//   - *StockCandlesRequest: A pointer to the newly created StockCandlesRequest instance. This instance
