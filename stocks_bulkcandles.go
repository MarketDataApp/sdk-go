...
// # Generated By
//
//   - BulkStockCandles(client ...*MarketDataClient) *BulkStockCandlesRequest: BulkStockCandles creates a new *BulkStockCandlesRequest and returns a pointer to the request allowing for method chaining.
//
// # Setter Methods
//
