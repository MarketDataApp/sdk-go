...
Represents a SmartMid midpoint price for a stock. It is a lightweight alternative to [`Quote`](./quote.md) when only a single price per symbol is needed. Timestamps are normalized to US Eastern time.
