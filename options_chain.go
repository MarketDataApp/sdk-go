...
// # Generated By
//
//   - OptionChain(client ...*MarketDataClient) *OptionChainRequest: OptionChain creates a new *OptionChainRequest and returns a pointer to the request allowing for method chaining.
//
// # Setter Methods
//
